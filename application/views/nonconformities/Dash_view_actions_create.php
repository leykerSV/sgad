              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="card card-primary">
                          ...
                          <form action="<?php echo base_url() ?>index.php/Dash_controller_nonconformities/GuardaAccion/<?php echo $id; ?>" method="post">
						  		<div class="card-body">
								  ...
								  <div class="form-group" hidden>
									  <input type="text" class="form-control" name="lider" value=<?php echo $noconformidad['autor']; ?>>
								  </div>
